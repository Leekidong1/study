...
<div class="pay">
	...
	<div class="pay-info">
		<div class="info-top">
			<div class="info-sub">
				<div style="float: left; margin: 20px;">
					<img alt="" src="http://localhost:8090/flenda/upload/${fileName }" width="200px" height="100px">
				</div>
				<div style="float: right; margin: 20px; width: 170px; height: 100px; font-size: 20px; font-weight: bold;">${act.title }</div>
		...
		<div class="info-bottom">
			<div class="reserv-header">예약자 정보</div>
			<hr width="100%" style="background-color: #A9A9F5;">
	...
	<div class="pay_method">
		<div class="method-top">
			<div class="method-header">결제 방법&nbsp;<sub style="color: red;">(필수)</sub></div>
			<hr width="100%" style="background-color: #A9A9F5;">
		...
		<div class="method-bottom">
			<div class="method-header">약관 및 안내</div>
			<hr width="100%" style="background-color: #A9A9F5;">
	...
	IMP.request_pay({
		...
		*/
		...
		if (rsp.success) {
			...
			$.ajax({
				url:"payAf.do",
				data:{id:'${login.id}', name:rsp.buyer_name, email:rsp.buyer_email, orderNum:rsp.merchant_uid, phone:rsp.buyer_tel, bankName:rsp.bank_name, cardName:rsp.card_name, cardNum:rsp.card_number, ItemName:'${act.title }', payMethod:rsp.pay_method, paidMoney:rsp.paid_amount, totalCount:'${totalCount}', reservationDate:'${date }', userMemo:memo, usePoint:point, sellSeq:'${act.sellSeq}', useDate:'${date}' },
				success:function(message){
					if(message == 'success'){
						location.href="main_actdetail.do?seq='${act.sellSeq}'"; 
					}else{
						alert('주문추가 실패하였습니다');
						location.href="main_actdetail.do?seq='${act.sellSeq}'"; 
					}
