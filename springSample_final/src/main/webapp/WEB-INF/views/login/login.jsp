				...
				<form action="loginAf.do" name="frmFrom" id="_frmFrom" method="post">
					...
					<colgroup>
						...
						<tr>
							...
							<td>&nbsp;
								<input type="text" id="_userid" name="id" size="20px" style="border: 1px solid #dddddd;" placeholder="ID">
						...
						<tr>
							...
							<td>&nbsp;
								<input type="text" id="_pwd" name="pw" size="20px" style="border: 1px solid #dddddd;" placeholder="Password">
							</td>
						</tr>
						<tr>
