...
<!DOCTYPE html>
<html>
<title>MyPage_manageGroup</title>
...
$(document).ready(function() {
	$.ajax({	// 비동기통신
		url:"./control?param=mypage_group_manage",	// or url:"member?param=idcheck",
		type:"post",
		data:{ "id":'<%=mem.getId()%>' },
		datatype:"json",
			 ...
			 $.each(data.list, function(index, item) {
				...
				let showlist =	'<div class="card" style="max-width: 20rem;">' +
								    ...
								    '<div class="card-body">' +
								     ...
								     '<a href="mypage_manageGroup_detail.jsp?seq=' +item.groups_seq + '" class="btn btn-primary">일정관리</a>&nbsp;&nbsp;' +
								     '<a href="mypage_manageMember_detail.jsp?seq=' +item.groups_seq + '" class="btn btn-primary">운영관리</a>' + 	
								    '</div>' +
								 '</div>';
