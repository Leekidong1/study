...
// 날짜별 리스트
public String makeTable(int year, int month, int day, List<MeetingDto> list){
	String str = "";
	...
	for(MeetingDto dto : list){
		...
		if(date.equals(dates) && dto.getDel() != 1){
			str += "<tr><td style='padding: 0px; border:1;background-color: red; border-color: blue; radius=3'>";		
			str += "<a href='detail_main_groupdetail.jsp?seq=" + dto.getGroups_seq() + "'>";
...
String pp = String.format("<a href='%s?year=%d&month=%d'><img src='image/left.gif' width='20px' height='20px'></a>", 
						"mypage_calendar.jsp",year-1, month);
// month --;
String p = String.format("<a href='mypage_calendar.jsp?year=%d&month=%d'><img src='image/prec.gif' width='20px' height='20px'></a>", 
							year, month-1);
// month ++;
String n = String.format("<a href='mypage_calendar.jsp?year=%d&month=%d'><img src='image/next.gif' width='20px' height='20px'></a>", 
							year, month+1);
// year ++;
String nn = String.format("<a href='mypage_calendar.jsp?year=%d&month=%d'><img src='image/last.gif' width='20px' height='20px'></a>", 
							year+1, month);
...
List<MeetingDto> list = dao.getMyList(mem.getId(), year + CalUtil.two(month + ""));
...
%>
	...
	<col width="100"><col width="100"><col width="100">
		...
		<tr height="50" style="background-color: #f0f0f0;color: black;">
