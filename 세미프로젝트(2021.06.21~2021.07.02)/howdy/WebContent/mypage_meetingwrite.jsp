...
<%
String groups_seq = request.getParameter("seq");
...
<div align="center">
	...
	<input type="hidden" name="param" value="metwriteAf">
	<input type="hidden" name="groups_seq" value="<%=groups_seq %>">
	...
	<input type="hidden" name="longitude" id="longitude" value=""><!-- longitude(경도) -->
		<table class="table table-bordered" style="width: 65%">
			...
			<tr>
				...
				<td>
					<select name="category">
			            <option value="단기일정">단기일정</option>
			            <option value="장기일정">장기일정</option>
			            <option value="주말일정">주말일정</option>
			...
			<tr>
				<th>정원</th>
				<td>
					<input type="text" size="5" name="max_mem">명
				</td>
			</tr>
			<tr>
				<th>시작일</th>
