...
public class PollDto implements Serializable {
	...
	private String question; 	// 투표 질문 -> 예)좋아하는 과일은?
	private Date sdate; 		// 투표 시작일
	private Date edate; 		// 투표 종료일
	private Date regdate; 		// 투표 등록한 날(만든날)
	
	private int itemcount;		// 보기수	-> 2 ~ 10
	private int polltotal;		// 해당투표의 전체 투표한 사람수
	
	private boolean vote;		// 로그인한 멤버가 이 투표에 투표를 했는지 여부묻기
